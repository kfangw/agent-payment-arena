...
Run:  python -m arena.experiments.settlement.inject --cell "E-outage x F1" --axis lambda --seed 2001
"""
...
def run_axis(
    ...
    eps = eps_for(mean_exposure)  # frozen anchor (arena.experiments.settlement.design)

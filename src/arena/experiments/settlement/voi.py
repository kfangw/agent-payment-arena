...
distribution.
    ...
    python -m arena.experiments.settlement.voi --flow F2 --seed 8 --out results_t1
"""
...
def run_cell(flow_name, seed, n_tune, n_eval, results, results_grid):
    ...
    base = json.load(open(Path(results) / f"settlement_E-outage_{flow_name}_mid_s{seed}.json"))
